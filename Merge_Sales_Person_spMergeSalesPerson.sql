/*
  Purpose: This stored procedure is to merge two sale's people's records,
...
create or alter procedure dbo.spMergeSalesPerson (
...
grant exec on dbo.spMergeSalesPerson to public


/* ---- script to execute stored procedure to merge 
exec dbo.spMergeSalesPerson
